...
\begin{itemize}
    ...
    \item \textbf{Degree} (of a monomial $P$): The sum of the powers of its variables. \emph{Denoted by} $\bm{d(P)}$.
    \begin{itemize}
    ...
    \begin{itemize}
        ...
        \item For $S_3$\dots
        \begin{itemize}
            \item The trivial's polynomial is 1 and \ydiagram{3}.
        ...
        \begin{itemize}
            ...
            \end{itemize}
            \item For $\lambda=(4,3,1)$, we have $\Delta_{123}\Delta_{45}\Delta_{67}$, and we act by $S_8$ upon this! Explicitly, we have $S_8(x_1-x_2)(x_1-x_3)(x_2-x_3)(x_4-x_5)(x_6-x_7)$.
    ...
    \end{itemize}
    \item We need to prove reducibility and not pairwise isomorphic to make sure that this construction is valid, but that's easy! We'll do this next Monday.
\end{itemize}
...
\begin{itemize}
    ...
    \item Remain to show: $\sigma_1,\dots,\sigma_n$ are algebraically independent $P(\sigma_1,\dots,\sigma_n)=0$ implies that $P=0$.
    \begin{itemize}
