    ...
    \begin{enumerate}
        ...
        \begin{proof}[Answer]
            ...
            \begin{empheq}[box=\fbox]{align*}
                \begin{split}
                    V_{(3,2)} ={}& \big\langle\overbrace{(x_1-x_2)(x_3-x_4)}^a,\overbrace{(x_1-x_3)(x_2-x_4)}^b,\overbrace{(x_1-x_4)(x_2-x_5)}^c\\
                &\hspace{4.5em}
                    \underbrace{(x_1-x_2)(x_3-x_5)}_d,
                    \underbrace{(x_1-x_3)(x_2-x_5)}_e
                \big\rangle
                \end{split}
            \end{empheq}
            ...
            \end{equation*}
            \vspace{-0.3em}
            Although we could row-reduce this matrix to prove that it is full column rank, we can also observe that $b,c,d,e$ each have a different nonzero entry in the bottom four slots, while $a$ is zero in all four slots, thus proving linear independence.
        \end{proof}
        \item Compute the character of this representation.
        \begin{proof}[Answer]
            We do this directly by looking at where certain representative elements of $S_5$ map the basis of $V_{(3,2)}$. Filling in the following table, to matrices, to traces finishes the problem.
            \begin{center}
                \small
                \renewcommand{\arraystretch}{1.2}
        ...
        \end{proof}
    \end{enumerate}
    \item \textbf{(20)} Consider finite groups $G$ and $H$. Suppose that $V_1,\dots,V_n$ are irreducible representations of $G$ and $W_1,\dots,W_m$ are irreducible representations of $H$. Define representations of the group $G\times H$ on the vector spaces $V_i\otimes W_j$. Prove that these representations are irreducible and that these are all irreducible representations of $G\times H$.
    \begin{proof}[Answer]
        See Theorem \ref{trm:productIrreps} from \textcite{bib:Serre}.
    \end{proof}
\end{enumerate}
