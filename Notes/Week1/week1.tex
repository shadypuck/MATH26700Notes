...
\begin{itemize}
    ...
    \begin{figure}[h!]
        ...
        \begin{tikzpicture}
            ...
            \draw [thick,->,shorten >=4pt,shorten <=4pt] (0) to[bend left=20] (4);
            \draw [thick,->,shorten >=4pt,shorten <=4pt] (4) to[bend left=20] (0);
            \draw [thick,->,shorten >=4pt,shorten <=4pt] (0) to[bend left=20] (3);
            \draw [thick,->,shorten >=4pt,shorten <=4pt] (3) to[bend left=20] (2);
            \draw [thick,->,shorten >=4pt,shorten <=4pt] (2) to[bend left=20] (1);
            \draw [thick,->,shorten >=4pt,shorten <=4pt] (2) to[bend left=20] (0);
            \draw [thick,->,shorten >=4pt,shorten <=4pt] (5) to[bend left=20] (6);
            \draw [thick,->,shorten >=4pt,shorten <=4pt] (6) to[bend left=20] (5);
        \end{tikzpicture}
