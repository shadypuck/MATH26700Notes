...
\begin{itemize}
    ...
    \begin{proof}
        ...
        \end{equation*}
        So $\prod_{i=1}^na_i\in\Z$\footnote{How do we know that this is an integer??}, but since it's an integer with absolute value less than 1, it must be zero.\footnote{How doe proving that the product of the $a_i$'s is zero prove that $a_1=0$??}
    \end{proof}
